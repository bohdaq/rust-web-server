...
use crate::json::object::tests::deserialize_json_with_nested_object_null_field_to_struct::some_object::SomeObject;
...
fn parse_nested_object_property_null() {
    let path = FileExt::build_path(&["src", "json", "object", "tests", "deserialize_json_with_nested_object_null_field_to_struct", "some-object.json"]);
