...
fn deserialize_json_extra_comma_after_null_last_property() {
    let path = FileExt::build_path(&["src", "json", "object", "tests", "deserialize_json_extra_comma_after_null_last_property", "some-object.json"]);
    ...
    assert_eq!("provided json is not valid. error near byte 23 of 23 `{\r\n  \"prop_b\": null,\r\n}`", message);
