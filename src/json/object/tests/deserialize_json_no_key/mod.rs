...
use crate::json::object::tests::deserialize_json_no_key::example_object::ExampleObject;

#[test]
fn deserialize_json_no_key() {
    let path = FileExt::build_path(&["src", "json", "object", "tests", "deserialize_json_no_key", "example-object.json"]);
