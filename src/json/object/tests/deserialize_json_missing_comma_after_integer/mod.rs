...
use crate::json::object::tests::deserialize_json_missing_comma_after_integer::example_object::ExampleObject;

#[test]
fn deserialize_json_missing_comma_after_integer() {
    let path = FileExt::build_path(&["src", "json", "object", "tests", "deserialize_json_missing_comma_after_integer", "example-object.json"]);
