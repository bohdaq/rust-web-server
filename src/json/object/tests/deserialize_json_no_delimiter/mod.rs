...
use crate::json::object::tests::deserialize_json_no_delimiter::example_object::ExampleObject;

#[test]
fn deserialize_json_no_delimiter() {
    let path = FileExt::build_path(&["src", "json", "object", "tests", "deserialize_json_no_delimiter", "example-object.json"]);
    ...
    assert_eq!("while seeking for property delimiter ':', found unexpected character: f", message);
