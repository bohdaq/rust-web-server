...
use crate::json::object::tests::deserialize_json_no_closing_curly_brace::example_object::ExampleObject;

#[test]
fn deserialize_json_no_closing_curly_brace() {
    let path = FileExt::build_path(&["src", "json", "object", "tests", "deserialize_json_no_closing_curly_brace", "example-object.json"]);
