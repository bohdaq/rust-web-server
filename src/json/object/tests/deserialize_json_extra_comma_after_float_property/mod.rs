...
use crate::json::object::tests::deserialize_json_extra_comma_after_float_property::example_object::ExampleObject;

#[test]
fn deserialize_json_extra_comma_after_float_property() {
    let path = FileExt::build_path(&["src", "json", "object", "tests", "deserialize_json_extra_comma_after_float_property", "example-object.json"]);
