...
use crate::json::object::tests::deserialize_json_extra_comma_after_string_property::example_object::ExampleObject;

#[test]
fn deserialize_json_extra_comma_after_string_property() {
    let path = FileExt::build_path(&["src", "json", "object", "tests", "deserialize_json_extra_comma_after_string_property", "example-object.json"]);
