...
fn deserialize_json_extra_comma_after_string_property() {
    let path = FileExt::build_path(&["src", "json", "object", "tests", "deserialize_json_extra_comma_after_string_property", "some-object.json"]);
    ...
    assert_eq!("provided json is not valid. error near byte 32 of 32 `{\r\n  \"prop_b\": \"sample text\",\r\n}`", message);
