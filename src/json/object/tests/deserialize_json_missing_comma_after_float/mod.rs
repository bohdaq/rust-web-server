...
use crate::json::object::tests::deserialize_json_missing_comma_after_float::example_object::ExampleObject;

#[test]
fn deserialize_json_missing_comma_after_float() {
    let path = FileExt::build_path(&["src", "json", "object", "tests", "deserialize_json_missing_comma_after_float", "example-object.json"]);
    ...
    assert_eq!("there are not expected characters after number (expected comma): \" after \r\n  \"prop_e\":4356.257", message);
